          ...
          <div class="content-header-left col-md-12 col-12 mb-2">
               <div class="row breadcrumbs-top">
                    <div class="col-12">
                         ...
                         <a role="button" class="btn btn-primary float-end" href="{{route('product.create')}}">Add Product</a></li>
                    </div>
               </div>
          </div>
     </div>
     <div class="content-body">
          <section id="basic-datatable">
               <div class="row">
                    <div class="col-12">
                         <div class="card p-2">
                              <table id="product_list" class="datatables-basic table">
                                   <thead>
                                        <tr>
                                             <th>#</th>
...
<script type="text/javascript">
     ...
     //Product list listing using ajax server side datatable
     var table = '';
     $(function() {
